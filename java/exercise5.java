...
BFG(int ammo, int damage) - задаем значения лишь двух параметров, количества патронов и урон,
поле name инициализируется значением по умолчанию;
...
Также переопредели метод toString(), чтобы он возвращал для класса BFG строку в формате <NAME>, ammo: <AMMO>, damage: <DAMAGE>.
Вместо <NAME>, <AMMO>, <DAMAGE> подставляются значения полей name, value и damage.
 */
